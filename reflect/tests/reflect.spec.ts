...
describe('Reflect', () => {
    describe('createAttribute', () => {
        ...
        test('Construction parameter injection', () => {
            ...
            expect(getAttribute(Inject, Controller2)?.constructorTypes).toEqual([EventManager]);
            expect(getAttribute(Inject, Controller2)?.type).toBeUndefined();
