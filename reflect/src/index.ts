...
export function isCallable(func): func is Function {
 ...
 */
export function isClass(value): value is IClass { return is.Class(value) }
 ...
 * @deprecated Use @azera/util
 */
export function isFunction(value): value is Function { return is.Function(value); }
