...
export function constrcutorParamTypes(target: any) {
...
export const isFunction = (value: any): value is Function => typeof value === "function" && !(value.prototype && value.prototype.constructor)
export const isClass = (value: any): value is Constructor<any> => typeof value === "function" && value.prototype && value.prototype.constructor;
