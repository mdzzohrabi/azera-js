...
export declare type Factory<T = {}> = Constructor<IFactory<T>> | FunctionOf<T>;
export declare type InjectableFunction<T = any> = {
    (...params: any[]): T;
    $inject?: string[];
};
export declare type FunctionOf<T> = (...params: any[]) => T;
export declare type Injectable<T = any> = InjectableFunction<T> | Function | Array<string | Function | FunctionOf<T>>;
export declare type InvokableFunctions<T> = Injectable<T> | Constructor<T> | Factory<T>;
export declare type Invokable<T> = InvokableFunctions<T> | string | T;
...
export declare const get: Container['invoke'];
...
export declare class Bundle {
     ...
     * Bootstrap module
     */
    boot(...params: any[]): void;
    /**
     * Desctruct bundle
     */
    destruct(...params: any[]): void;
    /**
     * Run
...
export declare class Kernel {
    ...
    container: Container;
    /** Kernel environment */
    static DI_PARAM_ENV: string;
    /** Kernel boot start timestamp */
    static DI_PARAM_BOOTSTART: string;
    /** Kernel boot end timestamp */
    static DI_PARAM_BOOTEND: string;
    /** Kernel run parameters */
    static DI_PARAM_PARAMETERS: string;
    /** Kernel loaded config file path */
    static DI_PARAM_CONFIG_FILE: string;
    /** Application root path */
    static DI_PARAM_ROOT: string;
    ...
    constructor(env?: string | undefined, bundles?: Bundle[], container?: Container);
     ...
     */
    addService(...services: Function[]): this;
     ...
     */
    loadConfig(config: string | object): Promise<this>;

    /**
     * Load parameters from json file or object
     * @param file Json File
     */
    loadParameters(file: string | object): this;
     ...
     */
    bootAndRun(configFile?: string, ...params: any[]): Promise<void>;
     ...
     */
    static createWebApp(port: number, ...controllers: Function[]): Promise<Kernel>;
}
